...
const AssignedSubjectList = ({ subject, studentId }) => {
    ...
    return (
        <Container>
            <Row>
                ...
                <Col><Button variant="outline-danger" size="sm" className="mb-1" onClick={handleDeleteSubjectFromStudent}>X</Button></Col>
                {loading && <p>Loading...</p>}
...
export default AssignedSubjectList;